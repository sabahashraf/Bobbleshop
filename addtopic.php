...
<canvas id="canvas" style = "padding-top:150px;margin-right:50px;" width="300" height="500">Alternative content</canvas>
 ...
 <h1 class = "h2" style = " border-bottom:3px solid purple;padding-top:20px;margin-bottom:40px;padding-bottom:10px;">Add a topic</h1>
...
$res = mysqli_query($myclass -> mysqli	, $sql)or die (mysqli_error($myclass -> mysqli	));
...
<input class="form-control" type="email" id="topic_owner" name="topic_owner" size="40"
        maxlength="150" required /></p>

<p><label for="topic_title">Topic Title:</label><br/>
<input class="form-control" type="text" id="topic_title" name="topic_title" size="40"
        maxlength="150" required /></p>

<p><label for="post_text">Post Text:</label><br/>
<textarea class="form-control" id="post_text" name="post_text" rows="8"
          cols="40" ></textarea></p>

<button class="btn btn-primary" type="submit" name="submit" value="submit" style = "float:right">Add Topic</button>
...
<p  style = "margin-top:50px">Would you like to <a href="catlist.php">see topiclist</a>?</p>
</div>
